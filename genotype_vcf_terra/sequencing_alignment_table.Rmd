...
Since md5sums are not provided for these files, we will need to retrieve them from the google cloud metadata. We select only the first five rows an an example so the code runs faster.
