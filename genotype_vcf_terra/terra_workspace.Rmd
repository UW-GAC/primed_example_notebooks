...
population_descriptors <- pop_desc %>%
  mutate(descriptor_type = "population | superpopulation",
         population_descriptor = paste(population, superpopulation, sep=" | ")) %>%
  select(subject_id, population_descriptor, descriptor_type, country_of_recruitment)
