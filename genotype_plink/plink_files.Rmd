...
In addition to the PLINK files, we add the converted VCF to the file table.

```{r}
array_file <- array_file %>%
  bind_rows(tibble(md5sum = "72162775a2858f36b9fbcdee1aaf7a6f",
                   file_path = paste0(bucket, "/submissions/c5866edd-7f16-448a-b8af-3a613cfa0a55/plink2_bed2vcf/6d2f5aea-51d5-4ada-b96b-c800dae34ad3/call-results/hapmap3_r3_b37_Ilmn1M.vcf.gz"),
                   file_type = "VCF"))
```
