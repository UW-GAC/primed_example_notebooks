...
* [Genotype data from PLINK files](genotype_import/plink_files.nb.html)
    * [example workflow inputs](https://github.com/UW-GAC/primed_example_notebooks/tree/main/genotype_import/workflows)
* [Files already in a Terra workspace](genotype_existing/terra_workspace.nb.html)
    * [example workflow inputs](https://github.com/UW-GAC/primed_example_notebooks/tree/main/genotype_existing/workflows)
