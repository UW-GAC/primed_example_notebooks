...
## Preparing data in the PRIMED data model

* [Genotype data from PLINK files](genotype_plink/plink_files.nb.html)
...
* [Sequencing alignment table](genotype_vcf_terra/sequencing_alignement_table.nb.html)
...
## Analyses with PRIMED data

* [Combining GSR data from multiple workspaces](analysis/CRC_summary_stats.nb.html)
* [Preparing a phenotype file for GWAS](analysis/pheno_file_gwas.nb.html)
